...
{exbVersion:"1.13.0",
exbBuildNum:"230",
exbBuildCommit:"38927b2caaa9f5861785f80b9314d38acaa2db69",
exbBuildBranch:"origin/release/dev1.13",
exbExtensionsBuildCommit:"3611908a8953304d4c1bb91527d3f520e05384af",
exbExtensionsBuildBranch:"origin/release/dev1.13",
exbBuildDate:"20231108.161238.CST",
productVersion:"ArcGIS Experience Builder"
};
function initJimuConfig() {
    const e=JSON.parse(document.getElementById("webpack-options").innerText);
    let t=e.mountPath;
    const r=e.isOutOfExb;
    let n=e.hostEnv;
    const{appFolderName:i,useStructuralUrl:o,isDevEdition:s,buildNumber:a,isBuilder:u,isSite:c,isInPortal:d}=e;
    r?t=getPath():d&&(t=getDeployContextFromLocation()+"apps/experiencebuilder/",
    e.arcgisJsApiUrl=getDeployContextFromLocation()+"jsapi/jsapi4/"),
    s||d||("experiencedev.arcgis.com"===location.hostname?n="dev":"experienceqa.arcgis.com"===location.hostname?n="qa":"experience.arcgis.com"===location.hostname&&(n="prod")),
    t||(t="/"),
    /\/$/.test(t)||(t+="/");
    let f=t;
    "site"!==i&&(f=t+i+"/"),
    window.jimuConfig= {
        ...
        appFolderName:i,
        rootPath:f,
        baseUrl: 'c:/users/jackhann/EXB/Client/',
        useStructuralUrl:o,
        isInPortal:d,
        isDevEdition:s,
        arcgisJsApiUrl:'/dist/',
...
function getDeployContextFromLocation(){
    let e=window.location.href.indexOf("/home/");
    e<0&&(e=window.location.href.indexOf("/apps/"));
    let t=window.location.href.substring(window.location.href.indexOf(window.location.host)+window.location.host.length+1,e);
    return"/"!==t&&(t="/"+t+"/"),t}function isInBuilder(){
        try{window.parent.jimuConfig}catch(e){
        return!1
    }
...
function clearCache(){
    if(!window.caches)return;const e=getCacheId();
    if(!e)return;const t=readCacheId();
    t?e!==t&&(caches.delete("exb-assets-cache"),
    caches.delete("arcgis-jsapi-cache"),
    setCacheId(e)):setCacheId(e)}function readCacheId(){
        try{
            return localStorage.getItem(CACHE_KEY)
        }
        catch(e){return console.error("Read Local storage error.",e),
        null
    }
}

function setCacheId(e){
    try{return localStorage.setItem(CACHE_KEY,e)
    }
    catch(e){
        return console.error("Set Local storage error.",e),
        null
    }
}

function getCacheId(){
    return window.jimuConfig.buildNumber?`${
        window.jimuConfig.exbVersion
    }
    -${
        window.jimuConfig.buildNumber
    }
    `:window.jimuConfig.exbVersion
}
...
function initSystemJS(){
    ...
    const e=window.SystemJS.constructor.prototype.resolve;
    function t(e){
        return new Promise((function(t,r){
            window.require([e],(function(e){
                t([[],function(t){
                    return t({
                        ...e,default:e,__useDefault:!0
                    }
                    ),{
    ...
    window.SystemJS.constructor.prototype.resolve=function(t,r){
        let n=e.apply(this,arguments);
        return/(^http:)|(^https:)|(^\/\/)/.test(t)||(n.indexOf("https://BASE_URL/")>-1?n=n.replace("https://BASE_URL/",window.location.origin+window.jimuConfig.baseUrl):n.indexOf("https://API_URL/")>-1&&(n=n.replace("https://API_URL/",window.jimuConfig.arcgisJsApiUrl)),/\/$/.test(n)||/\.css$/.test(n)||/\.json$/.test(n)||/\.wasm$/.test(n)||/\.js$/.test(n)||(n+=".js")),n};
        const r=window.SystemJS.constructor.prototype.instantiate;
        window.SystemJS.constructor.prototype.instantiate=function(e,n){
            if(/.css$/.test(e))return function(e){
                const t=document.getElementsByTagName("head")[0],
                r=!!window.navigator.userAgent.match(/AppleWebKit\/([^ ]*)/),
                n=function(e,t){
                    setTimeout((function(){
                        for(let r=0;
                        r<document.styleSheets.length;
                        r++)if(document.styleSheets[r].href===e.href)return t();
                        n(e,t)}),10)
                    }
                    ,
                    i=function(){};
                    return new Promise((function(o,s){
                        ...
                        c.rel="stylesheet",
                        c.href=e,
                        c.setAttribute("data-systemjs-css",""),
                        r?n(c,u):c.onload=function(){
                            u()
                        }
                        ,
                        c.onerror=function(e){
                            u(e.error||new Error("Error loading CSS file."))
                        }
                        ,
                        t.appendChild(c)}))}(e).then((function(){
                            const e=function(){};
                            return[[],function(t){
                                return t({
                                    default:e,__useDefault:!0
                                }
                                ),{
                                    setters:[],execute:function(){
                                        t("default",e)
                        ...
                        if(0===e.indexOf(window.jimuConfig.arcgisJsApiUrl)&&e!==window.jimuConfig.arcgisJsApiUrl+"init.js"){
                            let r=e.replace(window.jimuConfig.arcgisJsApiUrl,"");
                            return r=r.replace(/\.js$/,""),
                            t(r)
                    }
                    if(e.startsWith("https://amd-packages/")){
                        let r=e.replace("https://amd-packages/","");
                        return r=r.replace(/\.js$/,""),t(r)
                    }
...
function getPath(){
    ...
    if("/"===t||"/"===t.substr(t.length-1))e=t;
    else{
        const r=t.split("/"),
        n=r.pop();
        if(!(/\.html$/.test(n)||/\.aspx$/.test(n)||/\.jsp$/.test(n)||/\.php$/.test(n)))return!1;
        e=r.join("/")+"/"}return e
    }
    if("serviceWorker"in navigator&&(window.addEventListener("load",(function(){
        navigator.serviceWorker.register(window.jimuConfig.mountPath+"service-worker.js").then((function(e){console.log("Register a service worker.")
    }
    ))
    .catch((function(e){
...
({
    17:function(e,t,r){
        ...
        e.getAndroidVersionName=function(e){
            ...
            if(t.push(0),
            !(1===t[0]&&t[1]<5))return 1===t[0]&&t[1]<6?"Cupcake":1===t[0]&&t[1]>=6?"Donut":2===t[0]&&t[1]<2?"Eclair":2===t[0]&&2===t[1]?"Froyo":2===t[0]&&t[1]>2?"Gingerbread":3===t[0]?"Honeycomb":4===t[0]&&t[1]<1?"Ice Cream Sandwich":4===t[0]&&t[1]<4?"Jelly Bean":4===t[0]&&t[1]>=4?"KitKat":5===t[0]?"Lollipop":6===t[0]?"Marshmallow":7===t[0]?"Nougat":8===t[0]?"Oreo":9===t[0]?"Pie":void 0},
            ...
            e.compareVersions=function(t,r,n){
                ...
                (function(t){
                    ...
                    90:function(e,t,r){
                        ...
                        91:function(e,t,r){
                            ...
                            var c=function(){
                                ...
                                ,
                                t.test=function(e){
                                    return e.test(this._ua)},t.parseBrowser=function(){
                                        var e=this;
                                    ...
                                    t.getEngineName=function(e){
                                        return e?String(this.getEngine().name).toLowerCase()||"":this.getEngine().name||""},t.parseEngine=function(){
                                            var e=this;
                                            ...
                                            return t&&(this.parsedResult.engine=t.describe(this.getUA())),this.parsedResult.engine},t.parse=function(){
                                            ...
                                            ,
                                            t.isOS=function(e){return this.getOSName(!0)===String(e).toLowerCase()
                                            }
                                            ,
                        ...
                        93:function(e,t,r){
                            ...
                            ,
                            o=r(18),s=[{test:[/Roku\/DVP/],describe:function(e){
                        ...
                        94:function(e,t,r){
                            ...
                            ,
                            o=r(18),s=[{test:[/googlebot/i],describe:function(){
                                return{
                        ...
                        ,
                        {
                            test:[/ipad/i],describe:function(){return{
                    ...
                    ,
                    {
                        test:[/tablet(?! pc)/i],describe:function(){return{
...
95:function(e,t,r){
    ...
    o=r(18),s=[
        ...
        {
            test:function(e){
                return e.test(/presto/i)},describe:function(e){
                    var t={
...
function(){
    ...
    function t(e,t){
        if(-1!==e.indexOf("\\")&&(e=e.replace(O,"/")),"/"===e[0]&&"/"===e[1])return t.slice(0,t.indexOf(":")+1)+e;
        if("."===e[0]&&("/"===e[1]||"."===e[1]&&("/"===e[2]||2===e.length&&(e+="/"))||1===e.length&&(e+="/"))||"/"===e[0]){
            ...
            for(var i=r.slice(0,r.lastIndexOf("/")+1)+e,o=[],s=-1,a=0;
            a<i.length;
            a++)-1!==s?"/"===i[a]&&(o.push(i.slice(s,a+1)),s=-1):"."===i[a]?"."!==i[a+1]||"/"!==i[a+2]&&a+2!==i.length?"/"===i[a+1]||a+1===i.length?a+=1:s=a:(o.pop(),a+=2):s=a;
    ...
    function n(e,r,n,i,o){
        for(var s in e){
            ...
            if("string"==typeof d){
                var f=u(i,t(d,n)||d,o);
                f?r[c]=f:a("W1",s,d,"bare specifier did not resolve")
            }
        }
    }
    ...
    function i(e,t,i){
        ...
        {
            var s=r(o,t);
            n(e.scopes[o],i.scopes[s]||(i.scopes[s]={
        ...
        i.depcache[r(o,t)]=e.depcache[o];
        for(o in e.integrity||{

        }
        )
        i.integrity[r(o,t)]=e.integrity[o]
    }
...
function s(e,t){
    ...
    if(r){
        ...
        a("W2",r,n,"should have a trailing '/'")
    }
}
function a(t,r,n,i){
    console.warn(e(t,"Package target "+i+", resolving target '"+n+"' for "+r))
}
function u(e,t,r){
    for(var n=e.scopes,i=r&&o(r,n);
    i;
    ){
        var a=s(t,n[i]);
        if(a)return a;
...
function f(e,t,r,n){
    if(e.onload(r,t.id,t.d&&t.d.map(d),!!n),r)throw r
}
function l(t,r,n,i){
    var o=t[E][r];
    if(o)return o;
    var s=[],a=Object.create(null);
    P&&Object.defineProperty(a,P,{value:"Module"
}
);
var u=Promise.resolve().then((function(){
    return t.instantiate(r,n,i)
}
)).then((function(n){if(!n)throw Error(e(2,"Module "+r+" did not instantiate"));
var i=n[1]((function(e,t){
    o.h=!0;
    var r=!1;
    if("string"==typeof e)e in a&&a[e]===t||(a[e]=t,r=!0);
    else{
        for(var n in e)t=e[n],n in a&&a[n]===t||(a[n]=t,r=!0);
        e&&e.__esModule&&(a.__esModule=e.__esModule)
    }
    if(r)for(var i=0;
    i<s.length;i++){
        var u=s[i];u&&u(a)
...
(function(e){
    throw o.e=null,o.er=e,f(t,o,e,!0),e
}
)),
c=u.then((function(e){return Promise.all(e[0].map((function(n,i){
    var o=e[1][i],s=e[2][i];
...
return o=t[E][r]={
    id:r,i:s,n:a,m:i,I:u,L:c,h:!1,d:void 0,e:void 0,er:void 0,E:void 0,C:void 0,p:void 0
}
}
function h(e,t,r,n){
...
function p(e,t){
        ...
        function n(){
            try{
                ...
                if(r)return r=r.then((function(){
                    t.C=t.n,t.E=null,f(e,t,null,!0)
                }
                ),
                (function(r){
                    throw t.er=r,t.E=null,f(e,t,r,!0),r
                }
                )),t.E=r;t.C=t.n,t.L=t.I=void 0
            }
            catch(e){
                throw t.er=e,e
            }
    ...
    function g(){
        [].forEach.call(document.querySelectorAll("script"),(function(t){
            if(!t.sp)if("systemjs-module"===t.type){
                ...
                System.import("import:"===t.src.slice(0,7)?t.src.slice(7):r(t.src,v)).catch((function(e){
                ...
                t.sp=!0;var n=t.src?(System.fetch||fetch)(t.src,{
                    integrity:t.integrity,passThrough:!0
                }
                ).then((function(e){
                    ...
                    return r.message=e("W4","Error fetching systemjs-import map "+t.src)+"\n"+r.message,console.warn(r),"function"==typeof t.onerror&&t.onerror(),"{}"
                }
                )):t.innerHTML;
                R=R.then((function(){return n
                }
                )).then((function(r){
                    !function(t,r,n){
                        var o=
    ...
    var v,b="undefined"!=typeof Symbol,w="undefined"!=typeof self,y="undefined"!=typeof document,S=w?self:global;
    if(y){
        var M=document.querySelector("base[href]");
        M&&(v=M.href)
    }
    if(!v&&"undefined"!=typeof location){
        var _=(v=location.href.split("#")[0].split("?")[0]).lastIndexOf("/");
        -1!==_&&(v=v.slice(0,_+1))
    }
    var A,O=/\\/g,P=b&&Symbol.toStringTag,E=b?Symbol():"@",F=c.prototype;
    F.import=function(e,t,r){
        var n=this;
        return t&&"object"==typeof t&&(r=t,t=void 0),Promise.resolve(n.prepareImport()).then((function(){
            return n.resolve(e,t,r)
        }
        )).then((function(e){
            var t=l(n,e,void 0,r);
            return t.C||p(n,t)
        }
        ))
    }
    ...
    F.getRegister=function(){
        var e=A;return A=void 0,e
    }
    ;
    var x=Object.freeze(Object.create(null));
    S.System=new c;
    var B,j,R=Promise.resolve(),k={
        imports:{
    ...
    ,
    C=y;
    if(F.prepareImport=function(e){
        return(C||e)&&(g(),C=!1),R
    }
    ,
    y&&(g(),window.addEventListener("DOMContentLoaded",g)),F.addImportMap=function(e,t){
        i(e,t||v,k)
    }
    ,y){
        window.addEventListener("error",(function(e){
            L=e.filename,T=e.error
        }
        ));
        var N=location.origin
    }
    F.createScript=function(e){
    ...
    ,
    F.instantiate=function(t,r){
        var n=I[t];
        if(n)return delete I[t],n;
        var i=this;
        return Promise.resolve(F.createScript(t)).then((function(n){
            return new Promise((function(o,s){
                n.addEventListener("error",(function(){
                    s(Error(e(3,"Error loading "+t+(r?" from "+r:""))))
                }
                )),n.addEventListener("load",(function(){
                    if(document.head.removeChild(n),L===t)s(T);
                    else{
                        var e=i.getRegister(t);
                        e&&e[0]===B&&clearTimeout(j),o(e)
                    }
                }
    ...
    ,
    F.shouldFetch=function(){
        return!1
    }
    ,
    "undefined"!=typeof fetch&&(F.fetch=fetch);
    var J=F.instantiate,V=/^(text|application)\/(x-)?javascript(;|$)/;
    F.instantiate=function(t,r,n){
        var i=this;
        return this.shouldFetch(t,r,n)?this.fetch(t,{
            credentials:"same-origin",integrity:k.integrity[t],meta:n
        }
        )
        .then((function(n){
            if(!n.ok)throw Error(e(7,n.status+" "+n.statusText+", loading "+t+(r?" from "+r:"")));
            var o=n.headers.get("content-type");
            if(!o||!V.test(o))throw Error(e(4,'Unknown Content-Type "'+o+'", loading '+t+(r?" from "+r:"")));
    ...
    ,
    F.resolve=function(r,n){
        return u(k,t(r,n=n||v)||r,n)||function(t,r){
            throw Error(e(8,"Unable to resolve bare specifier '"+t+(r?"' from "+r:"'")))
        }
        (r,n)
    }
    ;
    var U=F.instantiate;
    F.instantiate=function(e,t,r){
        var n=k.depcache[e];
        if(n)for(var i=0;
            i<n.length;
            i++)l(this,this.resolve(n[i],e),e);
            return U.call(this,e,t,r)
        }
        ,
        w&&"function"==typeof importScripts&&(F.instantiate=function(e){
            var t=this;
        ...
        function(e){
            ...
            var r,n,i,o=e.System.constructor.prototype,s=o.import;
            o.import=function(o,a,u){
                return function(){
                    for(var o in r=n=void 0,e)t(o)||(r?n||(n=o):r=o,i=o)
                }
            (),
            s.call(this,o,a,u)
        }
    ...
    o.getRegister=function(){
        ...
        var s,c=function(o){
            var s,a,u=0;
            for(var c in e)if(!t(c)){
                if(0===u&&c!==r||1===u&&c!==n)return c;
                s?(i=c,a=o&&a||c):s=c===i,u++
            }
            return a
        }
...
("undefined"!=typeof self?self:global),function(e){
    var t=e.System.constructor.prototype,n=/^[^#?]+\.(css|html|json|wasm)([?#].*)?$/,i=t.shouldFetch.bind(t);
    t.shouldFetch=function(e){
        return i(e)||n.test(e)
    }
    ;
    var o=/^application\/json(;|$)/,s=/^text\/css(;|$)/,a=/^application\/wasm(;|$)/,u=t.fetch;
    t.fetch=function(t,n){
        return u(t,n).then((function(i){
            if(n.passThrough)return i;
            if(!i.ok)return i;
            var u=i.headers.get("content-type");
            return o.test(u)?i.json().then((function(e){
                return new Response(new Blob(['System.register([],function(e){return{execute:function(){e("default",'+JSON.stringify(e)+")}}})"],{
                    type:"application/javascript"
                }
                ))
            }
            )):s.test(u)?i.text().then((function(e){
                return e=e.replace(/url\(\s*(?:(["'])((?:\\.|[^\n\\"'])+)\1|((?:\\.|[^\s,"'()\\])+))\s*\)/g,(function(e,n,i,o){
                    return"url("+n+r(i||o,t)+n+")"
                }
                )),new Response(new Blob(["System.register([],function(e){return{execute:function(){var s=new CSSStyleSheet();s.replaceSync("+JSON.stringify(e)+');e("default",s)}}})']
                ,
                {type:"application/javascript"
            }
            ))
        }
        )):a.test(u)?(WebAssembly.compileStreaming?WebAssembly.compileStreaming(i):i.arrayBuffer().then(WebAssembly.compile)).then((function(r){
            e.System.wasmModules||(e.System.wasmModules=Object.create(null)),e.System.wasmModules[t]=r;
            var n=[],i=[];
            return WebAssembly.Module.imports&&WebAssembly.Module.imports(r).forEach((function(e){
                var t=JSON.stringify(e.module);
                -1===n.indexOf(t)&&(n.push(t),i.push("function(m){i["+t+"]=m}"))
            }
            )),
...
var G="undefined"!=typeof Symbol&&Symbol.toStringTag;
F.get=function(e){
    var t=this[E][e];
...
F.set=function(t,r){
    ...
    var n;
    G&&"Module"===r[G]?n=r:(n=Object.assign(Object.create(null),r),G&&Object.defineProperty(n,G,{value:"Module"
}
));
var i=Promise.resolve(n),o=this[E][t]||(this[E][t]={
    id:t,i:[],h:!1,d:[],e:null,er:void 0,E:void 0
}
);
return!o.e&&!o.E&&(Object.assign(o,{
    n,I:void 0,L:void 0,C:i
}
),n)
}
,
...
F.delete=function(e){
    ...
    var n=r.i;
    return r.d&&r.d.forEach((function(e){
        var t=e.i.indexOf(r);
        -1!==t&&e.i.splice(t,1)
    }
    )),
...
F.entries=function(){
    var e,t,r=this,n=Object.keys(r[E]),i=0,o={
        next:function(){for(;
            void 0!==(t=n[i++])&&void 0===(e=r.get(t));
            );
            return{
                done:void 0===t,value:void 0!==t&&[t,e]
            }
        }
    }
    ;
...
(),initSystemJS(),window.getPath=getPath,window.parent!==window)try{
