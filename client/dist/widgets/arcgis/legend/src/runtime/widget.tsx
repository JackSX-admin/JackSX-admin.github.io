let j = <link rel="stylesheet" href="c:/users/jackhann/4.28/esri/themes/main.css"></link>
/** @jsx jsx */
...
import "C:/Users/JackHann/4.28/esri/themes/dark/main.css"
  ...
  render () {
    ...
    if (!useMapWidget && !useDataSource) {
      ...
      content = (
        <div className='widget-legend'>
          {loadingContent}
          <div ref='legendContainer' style={{ height: '50%' }} />
    ...
    return (
      <div css={getStyle(this.props.theme, this.getStyleConfig())} className='widget-legend'>
        {content}
      </div>
    )
  }
